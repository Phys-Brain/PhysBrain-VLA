"""
Copy from: https://github.com/NVIDIA/Isaac-GR00T/blob/main/gr00t/model/modules/embodiment_conditioned_mlp.py
"""
...
class CategorySpecificMLP(nn.Module):
    ...
    def forward(self, x, cat_ids, mask=None):
        """
        Args:
            x: [B, T, input_dim] input tensor
            cat_ids: [B] category/embodiment IDs
            mask: [B, T, input_dim] optional mask tensor (1=valid, 0=masked)
        Returns:
